...
import LoadingSpec from '../src/components/LoadingSpec';
import SwaggerContainer from '../src/components/SwaggerContainer';
import {determineActiveTag, loadTags} from "../src/util";
import './index.css';
...
const Home: FunctionComponent = () => {
  ...
  const onTagsLoaded = (tags: string[]) => {
    const activeTag = determineActiveTag(window, tags);

    window.history.pushState({}, '', `?version=${activeTag}`);
