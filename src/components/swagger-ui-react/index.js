/**
 * This component has been copy-pasted from swagger-ui repo in order to add support for the deepLinking option.
 * Can be dropped when some maintainer places a comment in issue https://github.com/swagger-api/swagger-ui/issues/5580
 */
